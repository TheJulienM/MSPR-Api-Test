 ...
 */
class getApiKeyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ApiKeyRepository' shared autowired service.
     *
     * @return \App\Repository\ApiKeyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ApiKeyRepository.php';

        return $container->privates['App\\Repository\\ApiKeyRepository'] = new \App\Repository\ApiKeyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
